...
#define MAX_NO_MOBIL 5 // Ukuran string untuk nomor mobil (e.g., "M-01")
...
int main() {
    ...
    int pilihan_lokasi, pilihan_tujuan;
    long harga_tiket = 0;
    ...
    // Pilihan tujuan berdasarkan lokasi keberangkatan
    printf("\nPilih Tujuan Anda:\n");
    switch (pilihan_lokasi) {
        case 1: // Lokasi saat ini: Medan
            strcpy(lokasi_saat_ini_str, "Medan");
            printf("1. Siborongborong (Rp 90.000)\n");
            printf("2. Jawa (Rp 200.000)\n");
        ...
        case 3: // Lokasi saat ini: Siborongborong
            ...
            printf("1. Jawa (Rp 300.000)\n");
            printf("2. Medan (Rp 90.000)\n");
            printf("Masukkan pilihan Anda (1/2): ");
            scanf("%d", &pilihan_tujuan);
            while (getchar() != '\n');
            if (pilihan_tujuan == 1) {
    ...
    if (strcmp(konfirmasi_bayar, "ya") == 0) {
        ...
        printf("Selamat menikmati perjalanan Anda dengan KBT menggunakan mobil %s dari %s ke %s!\n", no_mobil_terpilih, lokasi_saat_ini_str, tujuan_str);
        printf("=============================================\n");
    } else {
        printf("\n=============================================\n");
